...
CREATE TABLE `posts` (
  ...
  CONSTRAINT `posts_ibfk_1` FOREIGN KEY (`thumbnail`) REFERENCES `images` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (1,'dungbk','dungbk@prtimes.co.jp','76Tviy76Rr7fG796796gGyivFGGHV67FTIVI79','08000089222','2021-02-26 08:30:53',NULL,NULL);
...
-- Dump completed on 2021-02-26  8:31:26
